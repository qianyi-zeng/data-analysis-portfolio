...
- 不是只会拉数：能把业务问题拆成指标树，并给出可执行动作。
- 不是只会做报表：能沉淀报表口径、自动化模板、看板和 SOP，降低团队重复劳动。
- 不是只看 GMV：会同时看流量、转化、供给、用户结构、补贴 ROI 和体验指标，避免单指标误判。
- 能在高节奏业务环境中交付稳定产出，适合电商、内容平台、本地生活、增长运营、商业分析岗位。

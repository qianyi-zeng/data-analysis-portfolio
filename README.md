...
| 业务场景 | 可交付结果 | 典型能力 |
| --- | --- | --- |
| 业务增长监控 | 日报、周报、经营看板、目标进度追踪 | 指标体系、Excel 自动化、TDA/BI 看板 |
| GMV 波动归因 | 渠道拆解、流量转化拆解、供给变化分析 | 漏斗分析、同比环比、异常定位 |
| 资源/补贴管理 | ROI 监控、预算节奏控制、活动复盘 | 钱效评估、风险规则、过程管控 |
| 专项活动立项 | 活动目标测算、预算分配、玩法设计、过程监控 | 经营策略、资源取舍、风险治理 |
| 新商/主播成长 | 冷启入池、分层提分、扶持效果追踪 | 分层模型、质量门槛、运营动作闭环 |
| 本地生活经营 | 商家诊断、投放复盘、直播增长策略 | ROI、核销、复购、新客结构 |
...
3. [资源扶持与补贴 ROI 管控](case-studies/03-subsidy-resource-roi-control.md)
...
6. [季节性专项活动立项与预算策略](case-studies/06-seasonal-campaign-planning.md)
...
- 支持行业季节性专项活动立项，覆盖目标测算、预算拆分、玩法设计、准入规则和过程监控。
...
- 不只看 GMV：会同时看流量、转化、供给、用户结构、补贴 ROI 和体验指标，避免单指标误判。
- 能在高节奏业务环境中交付稳定产出，适合电商、内容平台、本地生活、用户增长、商业分析岗位。
